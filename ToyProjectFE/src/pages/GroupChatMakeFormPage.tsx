...
export default function GroupChatMakeFormPage() {
      ...
      >
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
           ...
           <div>
            <label htmlFor="room-password" className="block text-sm/6 font-semibold text-gray-900">
              비밀번호
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div>
            <label htmlFor="max-players" className="block text-sm/6 font-semibold text-gray-900">
              최대 인원수
            </label>
            <div className="mt-2.5">
              <input
