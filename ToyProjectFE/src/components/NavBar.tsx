...
import { RoomDrawerToggleButton } from './RoomDrawer'
import { PlayerDrawerToggleButton } from './PlayerDrawer'
    ...
    <Disclosure as="nav" className="bg-gray-800 rounded-t-lg">
      <div className="mx-auto max-w-full px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
           <RoomDrawerToggleButton className = "mr-2 sm:mr-4 lg:mr-[100px]" />
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
              className="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white cursor-pointer"
            >
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-hidden focus-visible:ring-2 ">
                  <span className="absolute -inset-1.5" />
                  <span className="sr-only">Open user menu</span>
                  <img
                    alt=""
                    src={user.picture || 'images/guest_profile.png'}
          ...
          <PlayerDrawerToggleButton className='ml-2 sm:ml-4 lg:ml-[100px]' />
        </div>
      </div>
